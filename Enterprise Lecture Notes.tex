...
APIs are now requently RESTful, because it allows for Service Oriented Architecture to be applied much more easily. This will be covered in \ref{sec:REST}.
